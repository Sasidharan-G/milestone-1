...
@Dao interface SaleDao {
    ...
    @Insert suspend fun insertCustomerCredit(credit: com.company.billing.feature.masters.data.CustomerCreditEntity)
    @Transaction suspend fun saveSale(sale: SaleEntity, items: List<SaleItemEntity>, movements: List<StockMovementEntity>, customerCredit: com.company.billing.feature.masters.data.CustomerCreditEntity? = null) { 
        insertSale(sale)
        insertItems(items)
